...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 80 Program Card changed-session proof active; read-only adaptive preview marker visible on actual day cards; no Start Workout bridge; no Live Workout bridge; no mutation/storage; next Prompt 81 controlled user-confirmed marker application or roadmap-specified next step',
