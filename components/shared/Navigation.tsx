...
import { LayoutDashboard, Target, Dumbbell, Calendar, ClipboardList, TrendingUp, Activity, Crosshair, Settings, Menu, X, Database, Wrench, BookOpen } from 'lucide-react'
