...
export default function ProgramPage() {
  ...
  // HARDENED: Full try/catch/finally to prevent stuck spinner state
  // [PROGRAM_RETRY_VERSION] Visible runtime version proof - matches selector CORRIDOR_LOCK V1
  const PROGRAM_RETRY_VERSION = 'PROGRAM_REGEN_CORRIDOR_LOCK_V1_2026_04_13'
