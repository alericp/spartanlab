...
export const MOVEMENT_FAMILY_FATIGUE_DEFAULTS: Record<MovementFamily, {
  ...
  hip_hinge: { baseThreshold: 55, recoveryMultiplier: 0.8, description: 'Low recovery needs' },
  squat: { baseThreshold: 55, recoveryMultiplier: 0.8, description: 'Low recovery needs' },
