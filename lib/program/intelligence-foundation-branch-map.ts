...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 79 inserted source-foundation readiness gate active; read-only proof of high-impact family coverage; mutation locked; no Program Card/Start Workout/Live Workout changes; next original Prompt 80 of 87 Program Card changed-session proof',
