...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 72 local receipt authorization readiness active/read-only; durable write remains disabled; next Prompt 73 durable write preflight requires valid local receipt first; Program Cards, Start Workout, Live Workout still protected',
