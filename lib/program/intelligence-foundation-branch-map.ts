...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 76 future-session mutation draft preview active/no applied change; no Program Card/Start Workout/Live Workout changes; next Prompt 77 according to roadmap',
