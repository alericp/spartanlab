...
INSERT INTO training_doctrine_sources (
  ...
  ('src_batch_01_hybrid_ppl',
   ...
   'v1', TRUE, 'ingested', NULL, 'hypertrophy_logic',
  ...
  ('src_batch_01_forearm_health',
   ...
   'v1', TRUE, 'ingested', NULL, 'recovery_protection_logic',
  ...
  ('src_batch_01_pull_up_pro_phase_1',
   ...
   'v1', TRUE, 'ingested', 'Daniel Vadnal', 'vertical_vs_horizontal_pull_logic',
  ...
  ('src_batch_01_pull_up_pro_phase_2',
   ...
   'v1', TRUE, 'ingested', 'Daniel Vadnal', 'skill_progression_logic',
  ...
  ('src_batch_01_pull_up_pro_phase_3',
   ...
   'v1', TRUE, 'ingested', 'Daniel Vadnal', 'eccentric_logic',
  ...
  ('src_batch_01_front_lever',
   ...
   'v1', TRUE, 'ingested', NULL, 'skill_progression_logic',
  ...
  ('src_batch_01_lower_body_b',
   ...
   'v1', TRUE, 'ingested', NULL, 'lower_body_integration_logic',
