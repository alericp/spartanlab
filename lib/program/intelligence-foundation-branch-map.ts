...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 71 source lock active — official remaining Plan Logic mutation-readiness roadmap source exists (14 steps: P71–P84); next mutation work remains blocked by valid local receipt / authorization / no-write gates; Program Cards, Start Workout, Live Workout still protected',
