...
export function DashboardFullContent() {
  ...
  useEffect(() => {
    ...
    // Calculate training method emphasis
    try {
      if (data.profile) {
  ...
  return (
    <PageContainer>
      <SectionStack gap="xl">
        ...
        {/* PRIORITY 2: TRAINING CONSISTENCY */}
        ...
        {/* PRIORITY 3: READINESS + PROGRAM SNAPSHOT */}
