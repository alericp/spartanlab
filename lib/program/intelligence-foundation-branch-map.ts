...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 75 user-confirmed mutation authorization boundary active/preview-only; no automatic mutation; no Program Card/Start Workout/Live Workout changes; next Prompt 76 future-session mutation draft preview / no applied change',
