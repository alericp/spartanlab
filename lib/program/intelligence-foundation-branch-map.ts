...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 77 apply candidate visible/blocked unless explicit confirmation; no mutation/write/storage/runtime changes; no Program Card/Start Workout/Live Workout changes; next Prompt 78 according to roadmap',
