    ...
    metrics: [
      {
        ...
        unit: 'seconds',
        weight: 0.25,
        description: 'Core tension position matches dragon flag body line',
        assessmentMethod: 'Max hold with posterior pelvic tilt and tension maintained',
      },
      {
        ...
        unit: 'reps',
        weight: 0.25,
        description: 'Direct dragon flag progression with reduced lever',
        assessmentMethod: 'Max reps with strict form and full ROM',
      },
      {
        name: 'Leg Raise',
        category: 'core_compression',
        ...
        unit: 'reps',
        weight: 0.15,
        description: 'Hip flexor and compression strength foundation',
        assessmentMethod: 'Max strict leg raises from dead hang',
      },
      {
        ...
        unit: 'reps',
        weight: 0.15,
        description: 'Anti-extension strength and control',
        assessmentMethod: 'Max rollouts from standing',
      },
      {
        ...
        unit: '',
        weight: 0.10,
        description: 'Comfortable lower back extension for full ROM',
        assessmentMethod: 'Can achieve full body extension without pain',
      },
      {
        name: 'Hip Flexor Strength',
        category: 'skill_specific',
        ...
        unit: '',
        weight: 0.10,
        description: 'Active hip flexion power for both phases',
        assessmentMethod: 'Can control hip position throughout movement',
      },
    ],
    coachingNotes: [
      'Dragon flag is primarily a core anti-extension and compression skill',
      'Tuck progression is the most important preparation',
      'Do NOT rush to full range of motion',
      'Hip flexor strength and endurance are critical',
      'Lower back mobility must be developed alongside strength',
      'Works best with 2-3 days per week minimum exposure',
    ],
    commonMistakes: [
      'Progressing to full range before tuck is solid',
      'Neglecting hip flexor conditioning',
      'Forcing spinal extension without adequate mobility',
      'Poor body tension causing loss of position',
      'Too much volume too quickly causing lower back pain',
    ],
    injuryPrevention: [
      'Progress through tuck → tuck progression → negatives → assisted → full',
      'Include anti-rotation core work for balance',
      'Daily lower back mobility work',
      'Never train dragon flag 3 days in a row',
      'Stop immediately if lower back pain develops',
      'Pair with antagonist pulling work (rows, pull-ups)',
    ],
  },
  // [SKILL-PREREQUISITE-RECORD-COMPLETION] SkillType (declared in
  // lib/readiness/canonical-readiness-engine.ts:63) includes
  // one_arm_pull_up, one_arm_push_up, and planche_push_up. The
  // Record<SkillType,...> requires entries for all twelve. Seed the
  // missing three with conservative baseline/advanced targets and
  // category weights aligned to canonical readiness components.
  one_arm_pull_up: {
    skill: 'one_arm_pull_up',
    displayName: 'One Arm Pull-Up',
    difficulty: 'elite',
    typicalTimeToAchieve: '18-36 months',
    categoryWeights: {
      pulling_strength: 0.50,
      core_compression: 0.10,
      straight_arm_strength: 0.05,
      pushing_strength: 0.0,
      mobility: 0.05,
      tendon_tolerance: 0.10,
      skill_specific: 0.15,
    ...
    metrics: [
      {
        ...
        baselineTarget: 50,
        advancedTarget: 80,
        unit: '% bodyweight added',
        weight: 0.40,
        description: 'Maximal pulling strength foundation for one-arm capacity',
        assessmentMethod: 'Strict 1RM weighted pull-up as % of bodyweight',
      },
      {
        name: 'Strict Pull-Ups',
        category: 'pulling_strength',
        ...
        unit: 'reps',
        weight: 0.20,
        description: 'Pulling endurance baseline at bodyweight',
        assessmentMethod: 'Max consecutive strict pull-ups',
      },
      {
        name: 'Archer / Assisted One Arm Pull-Up',
        category: 'skill_specific',
        baselineTarget: 5,
        advancedTarget: 10,
        unit: 'reps per side',
        weight: 0.25,
        description: 'Direct progression toward one-arm capacity',
        assessmentMethod: 'Reps per side with band or archer assistance',
      },
      {
        name: 'Elbow / Connective Tissue Tolerance',
        category: 'tendon_tolerance',
        baselineTarget: 'good',
        advancedTarget: 'excellent',
        unit: '',
        weight: 0.15,
        description: 'Connective tissue durability for unilateral load',
        assessmentMethod: 'No elbow / wrist symptoms after heavy pulling cycles',
      },
    ],
    coachingNotes: [
      'Build a deep weighted pull-up base before isolating the one-arm pattern',
      'Use band-assisted and archer pull-ups as the primary skill driver',
      'Train both sides equally to avoid asymmetries',
      'Cycle volume to protect elbow connective tissue',
    ],
    commonMistakes: [
      'Skipping the weighted pull-up base',
      'Excessive volume on the dominant side',
      'Ignoring elbow or biceps tendon symptoms',
      'Using kipping or momentum to fake reps',
    ],
    injuryPrevention: [
      'Daily light elbow / wrist prep before sessions',
      'Cap unilateral pulling volume in any single session',
      'Pair with pushing and external rotator work',
      'Deload at first sign of medial elbow discomfort',
    ],
  },
  one_arm_push_up: {
    ...
    difficulty: 'advanced',
    typicalTimeToAchieve: '6-18 months',
    categoryWeights: {
    ...
    metrics: [
      {
        ...
        unit: 'reps',
        weight: 0.30,
        description: 'Push endurance baseline at bodyweight',
        assessmentMethod: 'Max consecutive strict push-ups',
      },
      {
        name: 'Archer Push-Up',
        category: 'skill_specific',
        ...
        unit: 'reps per side',
        weight: 0.30,
        description: 'Direct unilateral push progression',
        assessmentMethod: 'Strict archer reps per side',
      },
      {
        ...
        unit: '',
        weight: 0.20,
        description: 'Plank and side-plank stability under unilateral load',
        assessmentMethod: 'Side plank ≥ 60s and clean Pallof press control',
      },
      {
        name: 'Wrist & Shoulder Tolerance',
        category: 'tendon_tolerance',
        baselineTarget: 'good',
        advancedTarget: 'excellent',
        unit: '',
        weight: 0.20,
        description: 'Joint durability under unilateral pressing load',
        assessmentMethod: 'No wrist / anterior shoulder symptoms after pushing volume',
      },
    ],
    coachingNotes: [
      'Build push endurance and archer capacity before isolating one arm',
      'Resist hip rotation by bracing the core throughout the rep',
      'Hand placement directly under the working shoulder',
      'Progress feet width from wide to narrow as control improves',
    ],
    commonMistakes: [
      'Allowing the hips to rotate to reduce load',
      'Collapsing the working shoulder',
      'Skipping archer / lever progressions',
      'Training without symmetric volume on both sides',
    ],
    injuryPrevention: [
      'Wrist prep before every pushing session',
      'Cap unilateral pushing volume in any single session',
      'Pair with horizontal and vertical pulling',
      'Stop the set before form collapses',
    ],
  },
  planche_push_up: {
    ...
    metrics: [
      {
        ...
        unit: 'seconds',
        weight: 0.30,
        description: 'Straight-arm scapular protraction strength foundation',
        assessmentMethod: 'Max clean straddle planche hold',
      },
      {
        ...
        unit: 'reps',
        weight: 0.25,
        description: 'Bent-arm pushing pattern with planche lean',
        assessmentMethod: 'Max strict reps with significant forward lean',
      },
      {
        name: 'Weighted Dip',
        category: 'pushing_strength',
        ...
        unit: '% bodyweight added',
        weight: 0.20,
        description: 'Bent-arm pressing strength reservoir',
        assessmentMethod: 'Strict 1RM weighted dip as % of bodyweight',
      },
      {
        name: 'Wrist & Elbow Tolerance',
        category: 'tendon_tolerance',
        baselineTarget: 'good',
        advancedTarget: 'excellent',
        unit: '',
        weight: 0.25,
        description: 'Connective tissue durability under straight-arm load',
        assessmentMethod: 'No wrist / elbow symptoms after planche cycles',
      },
    ],
    coachingNotes: [
      'Hold-based planche capacity must precede push-up attempts',
      'Forward lean drives the difficulty curve more than depth',
      'Maintain protracted scapulae and posterior pelvic tilt throughout',
      'Pair straight-arm work with bent-arm pressing for balanced load',
    ],
    commonMistakes: [
      'Attempting planche push-ups without a clean straddle planche hold',
      'Letting the scapulae retract under load',
      'Using a piked hip to reduce difficulty',
      'Ignoring wrist / elbow symptoms',
    ],
    injuryPrevention: [
      'Daily wrist and elbow prep before pressing sessions',
      'Cap straight-arm work to 2-3 quality sessions per week',
      'Balance with antagonist pulling and external rotation',
      'Deload immediately on tendon symptoms',
    ],
  },
}
