...
export const INTELLIGENCE_FOUNDATION_BRANCH_MAP: readonly IntelligenceFoundationBranchEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nextSafeAction: 'Prompt 74 future-session mutation writer readiness boundary active/preview-only; no mutation; no Program Card/Start Workout/Live Workout changes; next Prompt 75 user-confirmed mutation authorization boundary',
