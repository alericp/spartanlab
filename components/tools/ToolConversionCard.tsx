...
/**
 * ToolConversionCard - Universal conversion funnel component for SEO tool pages
 * 
 * Displays after calculator results to guide users toward signup/program generation.
 * - Logged-in users → direct to program builder
 * - Anonymous users → direct to signup/onboarding
 * - Optionally passes tool data forward for smarter onboarding
 */
...
interface ToolConversionCardProps {
...
export function ToolConversionCard({
  context,
  toolData,
  headline,
  description,
...
export type { ToolConversionCardProps }
